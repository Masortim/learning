...
int main()
{
	...
	printf("%-9.8d\n", 1000);			// 9-значная строка из 8 символов с выравниванием по левому краю, отступ справа (00001000 )
	printf("%9.8d\n", 1000);			// 9-значная строка из 8 символов с выравниванием по правому краю, отступ слева ( 00001000)
